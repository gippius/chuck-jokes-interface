...
function httpGet(url) {
    return new Promise(function (resolve, reject) {
        ...
        var urlRegExp = new RegExp('^' + _app2.default.cachingURL);
        var cachedResponse = _app2.default.getFromCache(url);
        ...
        xhr.onload = function () {
            if (this.status == 200) {
                ...
                if (url.match(urlRegExp)) {
                    _app2.default.setToCache(url, this.response);
                }
...
var _header__nav = __webpack_require__(332);

var _header__nav2 = _interopRequireDefault(_header__nav);

var _section__random = __webpack_require__(333);

var _section__random2 = _interopRequireDefault(_section__random);

var _section__by_id = __webpack_require__(334);

var _section__by_id2 = _interopRequireDefault(_section__by_id);

var _section__search = __webpack_require__(335);

var _section__search2 = _interopRequireDefault(_section__search);

var _section__feed = __webpack_require__(336);

var _section__feed2 = _interopRequireDefault(_section__feed);
...
var sectionRandom = new _section__random2.default({
...
var sectionById = new _section__by_id2.default({
...
var sectionSearch = new _section__search2.default({
...
var sectionFeed = new _section__feed2.default({
...
var nav = new _header__nav2.default({
    navigationHeaderId: 'navigation'
});

nav.init([sectionRandom, sectionById, sectionSearch, sectionFeed]);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(92), __webpack_require__(327)(module)))
...
var Storage = function () {
    ...
    _createClass(Storage, [{
        key: "getFromCache",
        value: function getFromCache(url) {
            return localStorage.getItem(url);
        }
    }, {
        key: "setToCache",
        value: function setToCache(url, response) {
...
var NavigationHeader = function () {
    ...
    _createClass(NavigationHeader, [{
        ...
        value: function init(sections) {
            ...
            sections.forEach(function (section) {
                ...
                menuItem.addEventListener('click', function (e) {
                    ...
                    _this.selectMenuItem(e.target);
                });
            });
        }
    }, {
        key: 'initialTabOpen',
        value: function initialTabOpen(tabNumber) {
        ...
        value: function selectMenuItem(item) {
            ...
            [].concat(_toConsumableArray(this.menuItems)).forEach(function (element) {
                if (element.isSameNode(item)) {
                    element.classList.add('selected');
                    _this2.activeTab = item;
                } else {
...
var SectionRandom = function () {
    function SectionRandom(options) {
        _classCallCheck(this, SectionRandom);
    ...
    _createClass(SectionRandom, [{
        ...
        key: 'freezeButton',
        value: function freezeButton(element, disabledText) {
        ...
        key: 'unfreezeButton',
        value: function unfreezeButton(element) {
        ...
        value: function getRandomJoke() {
            ...
            (0, _http2.default)(url).then(function (res) {
                _this.unfreezeButton(_this.submitButton);
                _this.addJokeInSection(JSON.parse(res));
            }, function (err) {
                _this.unfreezeButton(_this.submitButton);
                _this.showError(err, url);
            });
        }
    }, {
        key: 'addJokeInSection',
        value: function addJokeInSection(res) {
    ...
    return SectionRandom;
}();

exports.default = SectionRandom;
...
var JokeById = function () {
    function JokeById(options) {
        _classCallCheck(this, JokeById);
    ...
    _createClass(JokeById, [{
        ...
        key: 'inputFormSentWithKeyboard',
        value: function inputFormSentWithKeyboard(e) {
        ...
        key: 'inputFormSubmit',
        value: function inputFormSubmit() {
            var _this = this;

            // side-trimmed value of input form
            var query = this.inputForm.value.replace(/^\s+|\s+$/g, '');
            var url = 'https://api.chucknorris.io/jokes/' + query;
            ...
            (0, _http2.default)(url).then(function (res) {
                _this.unfreezeButton(_this.submitButton);
                _this.renderSearchResultInSection(JSON.parse(res));
            }, function (err) {
                _this.unfreezeButton(_this.submitButton);
                _this.showError(err, url);
            });
        ...
        key: 'freezeButton',
        value: function freezeButton(el, disabledText) {
        ...
        key: 'unfreezeButton',
        value: function unfreezeButton(el) {
        ...
        key: 'blinkInputError',
        value: function blinkInputError() {
            var inputForm = this.inputForm;

            inputForm.classList.add('error');

            clearTimeout(this.inputFormBorderBlinkTimer);
            this.inputFormBorderBlinkTimer = setTimeout(function () {
                inputForm.classList.remove('error');
            }, 1000);
        }
    }, {
        key: 'renderSearchResultInSection',
        value: function renderSearchResultInSection(res) {
            this.outputContainer.innerHTML = '\n        <div class="section__joke-block">\n            <div class="section__joke_avatar_wrap">\n                <img src="' + res.icon_url + '" class="section__chuck_avatar">\n            </div>\n            <div class="section__joke_text">\n                ' + res.value + '\n            </div>\n        </div>';
        }
    }, {
        key: 'showError',
        value: function showError(err, url) {
            var errorMessageWrap = document.createElement('div');
            errorMessageWrap.classList.add('sections__error_message');

            // preventing possible XSS injection (user input in variable url)
            errorMessageWrap.innerText = '\u041E\u0431\u0440\u0430\u0431\u043E\u0442\u0447\u0438\u043A \u0437\u0430\u043F\u0440\u043E\u0441\u0430 \u0432\u0435\u0440\u043D\u0443\u043B \u043E\u0448\u0438\u0431\u043A\u0443 ' + err + '. \n        \n            \u0421 \u043F\u043E\u0447\u0442\u0438 100% \u0432\u0435\u0440\u043E\u044F\u0442\u043D\u043E\u0441\u0442\u044C\u044E \u044D\u0442\u043E \u043F\u0440\u043E\u0438\u0437\u043E\u0448\u043B\u043E \u0438\u0437-\u0437\u0430 \u0442\u043E\u0433\u043E, \u0447\u0442\u043E API             \u043D\u0435\u0430\u0434\u0435\u043A\u0432\u0430\u0442\u043D\u043E \u043E\u0431\u0440\u0430\u0431\u043E\u0442\u0430\u043B\u0430 URL ' + url + ', \u043A\u043E\u0442\u043E\u0440\u044B\u0439 \u0431\u0435\u0437 \u043F\u0440\u043E\u0431\u043B\u0435\u043C \u043E\u0442\u043A\u0440\u043E\u0435\u0442\u0441\u044F            \u0432 \u0431\u0440\u0430\u0443\u0437\u0435\u0440\u0435.';
...
var JokeSearch = function () {
    function JokeSearch(options) {
        _classCallCheck(this, JokeSearch);
    ...
    _createClass(JokeSearch, [{
        ...
        value: function inputFormSubmit() {
            ...
            if (query === '') {
                ...
                (0, _http2.default)(url).then(function (res) {
                    _this.unfreezeButton(_this.submitButton);
                    _this.renderSearchResultInSection(JSON.parse(res), query);
                }, function (err) {
                    _this.unfreezeButton(_this.submitButton);
                    _this.showError(err, url);
                });
        ...
        key: 'renderSearchResultInSection',
        value: function renderSearchResultInSection() {
            var res = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
            var query = arguments[1];

            if (res.total > 0) {
                this.outputContainer.innerHTML = res.result.splice(0, this.countSelectorForm.value).map(function (res) {
                    return '\n                <div class="section__joke-block">\n                    <div class="section__joke_avatar_wrap">\n                        <img src="' + res.icon_url + '" class="section__chuck_avatar">\n                    </div>\n                    <div class="section__joke_text">\n                        ' + res.value + '\n                    </div>\n                </div>';
                }).join('');
            } else {
        ...
        key: 'noResultFound',
        value: function noResultFound(query) {
            var errorMessageWrap = document.createElement('div');
            errorMessageWrap.classList.add('sections__error_message');
...
var SectionFeed = function () {
    function SectionFeed(options) {
        _classCallCheck(this, SectionFeed);
    ...
    _createClass(SectionFeed, [{
        ...
        key: 'initialFeedFill',
        value: function initialFeedFill(n) {
            var i = 0;
            while (i < n) {
        ...
        key: 'feedScrolled',
        value: function feedScrolled(e) {
            var menuItem = this.menuItem;
            if (menuItem.id !== 'navigation__feed' || !menuItem.classList.contains('selected') || e.deltaY < 0 || window.innerHeight + window.scrollY + 100 < document.body.offsetHeight) {
                return;
            }
        ...
        key: 'loadNewJokeToFeed',
        value: function loadNewJokeToFeed() {
            var _this = this;

            var url = 'https://api.chucknorris.io/jokes/random';
            (0, _http2.default)(url).then(function (res) {
                _this.addJokeToFeed(JSON.parse(res));
            }, function (err) {
                _this.showError(err, url);
            });
        }
        ...
        key: 'addJokeToFeed',
        value: function addJokeToFeed(res) {
            this.outputContainer.innerHTML += '\n        <div class="section__joke-block">\n            <div class="section__joke_avatar_wrap">\n                <img src="' + res.icon_url + '" class="section__chuck_avatar">\n            </div>\n            <div class="section__joke_text">\n                ' + res.value + '\n            </div>\n        </div>';
        }
    }, {
        key: 'showError',
